...
public class ListFavoritAdapter extends BaseAdapter {
    ...
    public ListFavoritAdapter(Context c, String[] numberWord, int[] numberImage){
        context = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            convertView = inflater.inflate(R.layout.row_item_favorit, null);
        }
